...
# The Democracy Index is an index compiled by the Economist Intelligence Unit (EIU), 
# a UK-based company. Its intention is to measure the state of democracy in 167 countries, 
# of which 166 are sovereign states and 164 are UN member states.
...
X = democracy_index[['democracy_index', 'electoral_processand_pluralism', 'functioning_of_government', 
                     'political_participation', 'political_culture', 'civil_liberties']].values
X = scale(X)
